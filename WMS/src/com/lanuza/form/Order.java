...
public class Order {
	...
	private void initialize() {
		...
		createTopButton(btnProcess,"stock.png", "Print", this::reflectOrdersToStock,new Rectangle(0, 0, 63, 38));
		panelButtons.add(btnProcess);
		
		btnPrint = new JButton();
		createTopButton(btnPrint,"stock.png", "Print", this::printTable,new Rectangle(63, 0, 63, 38));
		panelButtons.add(btnPrint);		
		
		btnSaveFile = new JButton();
		createTopButton(btnSaveFile,"stock.png", "Save as file", this::saveAsFile,new Rectangle(126, 0, 63, 38));
		panelButtons.add(btnSaveFile);
		
		btnCustomer = new JButton();
		createTopButton(btnCustomer,"stock.png", "Go to Customer", this::openCustomer,new Rectangle(189, 0, 63, 38));
		panelButtons.add(btnCustomer);
				
		btnProducts = new JButton();
		createTopButton(btnProducts,"stock.png", "Go to Product", this::openProduct,new Rectangle(252, 0, 63, 38));
		panelButtons.add(btnProducts);

		btnStock = new JButton();
		createTopButton(btnStock,"stock.png", "Go to Stock", this::openStock,new Rectangle(315, 0, 63, 38));
		panelButtons.add(btnStock);
							
		btnMode = new JButton();
		createTopButton(btnMode,"stock.png", "Change Mode", this::ChangeMode,new Rectangle(378, 0, 63, 38));
		panelButtons.add(btnMode);
		
		btnSearchBy = new JButton();
		createTopButton(btnSearchBy,"search.png", "Add", null,new Rectangle(301, 52, 63, 33));
	   ...
	   private void createTopButton(JButton button, String iconName, String tooltip, ActionListener listener,Rectangle bounds) {
	        String imagePath = "/com/lanuza/icons/" + iconName; // Adjust the folder name as needed
	        ...
	        button.setPreferredSize(new Dimension(bounds.width, bounds.height)); // Set preferred size
	    }
