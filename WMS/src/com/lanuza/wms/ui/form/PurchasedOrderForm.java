...
public class PurchasedOrderForm {
	...
	private JComboBox<Customer>	CustomerNameCombox;
	...
	private void getProductDetail(String selectedProduct) {
        ...
        int productPrice = (int) result.get("productPrice");
	...
	private void initialize() {
		...
		CustomerNameCombox = new JComboBox<Customer>();
		...
		CustomButton btnCustomer = new CustomButton(new Color(64, 128, 128), "Go to Customer", this::openCustomer, new Rectangle(189, 0, 63, 38),false,new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		panelButtons.add(btnCustomer); 
		
		CustomButton btnProducts = new CustomButton(new Color(64, 128, 128), "Go to Product", this::openProduct, new Rectangle(252, 0, 63, 38),false,new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		panelButtons.add(btnProducts); 
				
		CustomButton btnStock = new CustomButton(new Color(64, 128, 128), "Go to Stock", this::openStock, new Rectangle(315, 0, 63, 38),false,new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
